  ...
  return (
    <>
     <div className="container mx-auto mb-5">
        <div className="grid grid-cols-1 lg:gap-[0.5rem] xs:gap-[1rem] xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 my-[3rem] w-full">
          {labCardData?.map((data, index) => (
            <div
              className="flex flex-col bg-white border rounded-lg shadow-md w-[23rem] xs:w-[19rem]"
              key={index}
            >
              ...
              <div className="p-2 xs:p-5 flex gap-3 xs:flex-col">
                ...
                <div className="ml-auto flex flex-col items-end">
                  ...
                  <div className="flex justify-center mt-4">
                    <button className="bg-teal-600 hover:bg-teal-500 text-white py-2 px-6 rounded-full text-sm">
                      Select Lab
                    </button>
                  </div>
                </div>
