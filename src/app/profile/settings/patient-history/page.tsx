  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white shadow-md rounded-lg w-full max-w-md">
        ...
        <Link href={"/profile/settings"}><h1 className="block w-full mt-6 p-3 text-center pr-5 bg-gradient-to-r from-[#0CEDE6] text-white rounded-xl to-[#0A8E8A]">Patient History</h1></Link>
